...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO (Step 4: Assign a click listener to the select current location textview.)
        // START
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            // TODO (Step 7: Add a click event for selecting the current location)
            // START
    ...
    // TODO (Step 5: Create a function to check the GPS is enabled or not.)
    // START
    /**
